...
from algorithms.lfu_cache import lfu
from algorithms.lru import medir_lru
from algorithms.fifo import medir_fifo
from algorithms.mru import medir_mru
        ...
        for pattern_name, generator_func in patterns.items():
            ...
            for user_id in range(1, N_USERS + 1):
                ...
                for text_id in requests:
                    ...
                    time_taken = algo_func(verboso=False,
                                           cache_arquivos=cache, id_arquivo=text_id)
                    ...
                    collector.record(user_id, algo_name,
                                     pattern_name, text_id, is_hit, time_taken)
