...
def mru(dinamico: bool, cache_arquivos: CacheArquivos, blocos: list[int] | None = None, bloco: int | None = None) -> float:

    """
    Função de gerenciamento de cache MRU. Pode ser usada de 
    ...
    No modo Dinâmico, o conteúdo do arquivo será exibido.
        ...
        Examples:
            ...
            >>> mru(False, cache_arquivos, [1,2,3,4])
            0.00238
            >>> mru(True, cache=cache_arquivos, bloco=1)
            0.00238
    """
    tempo_inicio = time()
