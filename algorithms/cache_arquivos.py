class CacheArquivos:
    ...
    def contem_arquivo(self, id_arquivo: int) -> bool:
        ...
        Retorna True e incrementa o contador de hits se o arquivo está no cache.
    ...
    def add_arquivo(self, id_arquivo: int, conteudo: str) -> bool:
        """
        Adiciona arquivo no formato {id_arquivo:conteudo} no cache 
        e o ID do arquivo no fim da lista `ordem` se o cache não estiver cheio.
